...
public class Animationrr {

//    private static final Logger logger = new Logger(Animationrr.class);
//
...
//
//    private ListData fullDataPeople;
//    private PeopleService peopleService;

    public Animationrr(IterationResult iterationResult, InputData inputData) {
//        this.iterationResult = iterationResult;
//
////        создаем сетку указанной размерности
////        long startTime = System.currentTimeMillis();
//       // MeshService.createMesh(iterationResult.getGridPane(), inputData.getMeshSizeX(), inputData.getMeshSizeY());
////        long endTime = System.currentTimeMillis();
////        logger.timerInfo("Create mesh: ", (endTime - startTime));
//
////        генерируем базу данных популяции
////        long startTime2 = System.currentTimeMillis();
//        //peopleService = new PeopleService(iterationResult); // инициализируем сервис
...
//        iterationResult.getIterAll().setText(String.valueOf(fullDataPeople.healthyPeopleMap.size() + fullDataPeople.illPeopleMap.size()));
//        iterationResult.getIterIll().setText(String.valueOf(fullDataPeople.illPeopleMap.size()));
//        iterationResult.getIterHealthy().setText(String.valueOf(fullDataPeople.healthyPeopleMap.size()));
    }

//    public void start(CompletableFuture<Void> future) {
//        iterationResult.getGridPane().setGridLinesVisible(false);
//        iterationResult.getGridPane().getChildren().clear();
//        iterationResult.getGridPane().setGridLinesVisible(true);
//
//        long startTime = System.currentTimeMillis();
...
//        }
//        if (newCoordinate.getCoordinateX() > iterationResult.getGridPane().getColumnCount() - 1) {
//            newCoordinate.setCoordinateX(newCoordinate.getCoordinateX() - 1);
//        }
//        if (newCoordinate.getCoordinateY() > iterationResult.getGridPane().getRowCount() - 1) {
...
//        iterationResult.getGridPane().add(imageView, people.getCoordinate().getCoordinateX(), people.getCoordinate().getCoordinateY());
//    }
//
